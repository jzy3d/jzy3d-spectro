...
public class Util {
  ...
  /**
   * Converts the given array of numbers to an array of complex numbers where all the imaginary
   * parts are 0. The array size is [real.length][2], where each sample is complex; array[n][0] is
  ...
  /**
   * Tries very hard to create a JDialog which is owned by the parent Window of the given component.
   * However, if the component does not have a Window ancestor, or the component has a Window
   * ancestor that is not a Frame or Dialog, this method instead creates an unparented JDialog which
   * is always-on-top.
   * 
   * @param owningComponent The component that should own this dialog.
   * @param title The title for the dialog.
   * @return A JDialog that is either owned by the Frame or Dialog ancestor of owningComponent, or
   *         not owned but set to be alwaysOnTop.
   */
