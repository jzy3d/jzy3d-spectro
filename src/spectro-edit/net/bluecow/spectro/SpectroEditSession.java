 ...
 * <p>
 * This class also provides the main() method that is used to launch the
 * application.
 * 
 * @author fuerth
 */
public class SpectroEditSession {
     ...
     * will be initialized to correspond with the given file, which should be in
     * a PCM-encoded WAV or AIFF file.
     * 
     * @param wavFile
     *            The file to load
    ...
    /**
     * Launches the Spectro-Edit application by prompting the user for a file,
     * then creating a new session for editing that file.
     * 
     * @param args
     *            Currently ignored
     * @throws Exception
     *             If startup fails catastrophically
     */
