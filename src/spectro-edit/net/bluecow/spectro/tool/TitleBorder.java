...
/**
 * A border that only takes up space on the top of a component, and simply renders the title string
 * followed by a horizontal line long enough to fill out the component's current width.
 */
