...
/**
 * A button for choosing a tool. The tool selection is represented by an icon which is darkened when
 * selected.
 *
 * @see Tool
 */
public class ToolButton extends JRadioButton {
  ...
  protected void paintComponent(Graphics g) {
    ...
    getIcon().paintIcon(this, g, getWidth() / 2 - getIcon().getIconWidth() / 2,
