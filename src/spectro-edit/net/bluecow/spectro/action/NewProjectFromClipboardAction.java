...
/**
 * An action that attempts to create a new session based on the (audio) contents of the system
 * clipboard. This should be a great way to pull a segment of audio out of a project in another
 * program, clean it up, and then replace the original segment with the cleaned up version. The
 * problem is, I can't find any programs that put audio data on the OS X system clipboard.
 */
public class NewProjectFromClipboardAction extends AbstractAction {
  ...
  /**
   * Currently just pops up a list of data flavours available for the current clipboard item.
   */
  @Override
