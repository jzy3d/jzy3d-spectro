...
/**
 * A frame of audio data, represented in the frequency domain. The specific frequency components of
 * this frame are modifiable.
 */
public class Frame {
  ...
  /**
   * Sets the real component at idx. This method sets the new actual value, although it may make
   * sense to provide another method that scales the existing value.
   * 
  ...
  /**
   * Returns the time-domain representation of this frame. Unless the spectral data of this frame
   * has been modified, the returned array will be very similar to the array given in the
   * constructor. Even if the spectral data has been modified, the length of the returned array will
   * have the same length as the original array given in the constructor.
   */
