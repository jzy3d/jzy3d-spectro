...
class FFT {
  ...
  /**
   * FFT routine. The array length must be a power of two. The array size is [L][2], where each
   * sample is complex; array[n][0] is the real part, array[n][1] is the imaginary part of sample n.
   *
  ...
  /**
   * Takes the command line arguments, converts them into a floating-point array, then runs the
   * FFT_1d transform on the array twice. The array is printed before and after each transformation.
   */
