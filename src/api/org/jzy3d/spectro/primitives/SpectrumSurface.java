...
public class SpectrumSurface extends Geometry {
	 ...
	 * range of the input samples, which according to the Nyquist theorem is 1/2 the
	 * sampling rate (so for a 44100hz wav file, that's 0-22050hz).
	 */
	...
	public SpectrumSurface(SpectrumModel spectrum, int maxFreqId) {
		...
		Logger.getLogger(SpectrumSurface.class)
				.info(frameCount + " frames of " + frameWidth + " dims assuming max frequency " + maxFreqOfSpectrum);
	}
